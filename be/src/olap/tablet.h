...
public:
    static TabletSharedPtr create_tablet_from_meta(TabletMetaSharedPtr tablet_meta, DataDir* data_dir = nullptr);//根据tablet_meta创建tablet

    Tablet(TabletMetaSharedPtr tablet_meta, DataDir* data_dir);//构造函数
